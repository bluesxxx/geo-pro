    ...
    <div class="ent-shell">
        <div class="ent-footer__grid">
            ...
            <div>
                ...
                <a href="{{ route('site.about') }}">关于 GEO PRO</a>
            ...
            <div>
                ...
                <a href="https://github.com/bluesxxx/geo-pro" target="_blank" rel="noopener noreferrer">GitHub</a>
                <a href="https://github.com/bluesxxx/geo-pro/issues" target="_blank" rel="noopener noreferrer">Issues</a>
                <a href="https://github.com/bluesxxx/geo-pro/releases" target="_blank" rel="noopener noreferrer">Releases</a>
            </div>
            <div>
        ...
        <div class="ent-footer__bottom">
            ...
            <span>Built with GEO PRO · Enterprise Signature 21</span>
        </div>
    </div>
</footer>
