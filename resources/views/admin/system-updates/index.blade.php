...
@section('content')
    @php
        ...
        $githubUrl = (string) ($links['github'] ?? 'https://github.com/bluesxxx/geo-pro');
        $changelogLinks = is_array($links['changelog'] ?? null) ? $links['changelog'] : [];
        $changelogUrl = (string) ($changelogLinks[$localeForChangelog] ?? $changelogLinks['zh-CN'] ?? 'https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG.md');
        $flagLabels = [
                ...
                <div class="space-y-4">
                    <div class="rounded-lg border border-blue-100 bg-blue-50 p-4">
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            ...
                            <a href="{{ (string) ($diagnosticDocs['url'] ?? 'https://github.com/bluesxxx/geo-pro/blob/main/docs/deployment/DEPLOYMENT.md') }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-xs font-semibold text-blue-700 hover:bg-blue-100">
