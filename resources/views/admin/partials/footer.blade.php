@php
    $projectGithubUrl = 'https://github.com/bluesxxx/geo-pro';
    $xProfileUrl = 'https://jetsocio.com';
    $appVersion = (string) config('geoflow.app_version', '2.0');
    $changelogUrl = app()->getLocale() === 'en'
        ? 'https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG_en.md'
        : 'https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG.md';
    $helpDocsUrl = app()->getLocale() === 'en'
        ? 'https://github.com/bluesxxx/geo-pro/wiki/Home-English'
        : 'https://github.com/bluesxxx/geo-pro/wiki';
