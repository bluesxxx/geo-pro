...
class AdminSiteSettingsPageTest extends TestCase
{
    ...
    public function test_generated_netease_theme_variants_are_listed_with_public_assets(): void
    {
        ...
        $expectedThemes = [
            'geoflow-template-01-ink-editorial' => 'GEO PRO 01 Ink Editorial',
            'geoflow-template-02-market-briefing' => 'GEO PRO 02 Market Briefing',
            'geoflow-template-03-salmon-insight' => 'GEO PRO 03 Salmon Insight',
            'geoflow-template-04-red-opinion' => 'GEO PRO 04 Red Opinion',
            'geoflow-template-05-wire-clean' => 'GEO PRO 05 Wire Clean',
            'geoflow-template-06-public-broadcast' => 'GEO PRO 06 Public Broadcast',
            'geoflow-template-07-breaking-red' => 'GEO PRO 07 Breaking Red',
            'geoflow-template-08-section-blue' => 'GEO PRO 08 Section Blue',
            'geoflow-template-09-tech-spectrum' => 'GEO PRO 09 Tech Spectrum',
            'geoflow-template-10-wired-feature' => 'GEO PRO 10 Wired Feature',
            'geoflow-template-11-product-newsroom' => 'GEO PRO 11 Product Newsroom',
            'geoflow-template-12-saas-gradient' => 'GEO PRO 12 SaaS Gradient',
            'geoflow-template-13-linear-system' => 'GEO PRO 13 Linear System',
            'geoflow-template-14-knowledge-paper' => 'GEO PRO 14 Knowledge Paper',
            'geoflow-template-15-reading-medium' => 'GEO PRO 15 Reading Medium',
            'geoflow-template-16-newsletter-letter' => 'GEO PRO 16 Newsletter Letter',
            'geoflow-template-17-executive-review' => 'GEO PRO 17 Executive Review',
            'geoflow-template-18-consulting-insight' => 'GEO PRO 18 Consulting Insight',
            'geoflow-template-19-tech-review' => 'GEO PRO 19 Tech Review',
            'geoflow-template-20-research-journal' => 'GEO PRO 20 Research Journal',
            'geoflow-template-21-enterprise-signature' => 'GEO PRO 21 Enterprise Signature',
        ];
