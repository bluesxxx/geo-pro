...
GEO PRO se publica bajo la [Apache License 2.0](../../LICENSE). Puedes usarlo, copiarlo, modificarlo y distribuirlo, incluso con fines comerciales, siempre que conserves los avisos de copyright y licencia y cumplas los términos de patente, marcas y exención de garantías de Apache-2.0.
...
| 📡 Distribución multi-sitio | Canales GEO PRO Agent, WordPress REST y HTTP API genéricos, secretos, paquetes de sitio destino, modo estático, reglas rewrite, edición/eliminación remota, colas y logs |
...
| 🌍 i18n del admin | Chino, inglés, japonés, español, ruso y portugués (Brasil), con módulos GEO PRO 2.0 cubiertos |
...
GEO PRO 2.0 incluye estos cambios clave:
...
- **Distribución usable de extremo a extremo**: canales GEO PRO Agent, WordPress REST y HTTP API genéricos, secretos, pruebas de conexión, paquetes de sitio destino, modos estático/rewrite, sincronización de ajustes remotos, colas, logs, edición y eliminación remota.
- **Alcance de publicación explícito**: una tarea puede publicar en local y canales, solo en canales o solo en el sitio GEO PRO local; el modo local desactiva la selección de canales.
...
- **Cobertura i18n para los módulos actuales**: los módulos GEO PRO 2.0 ya no dependen de claves sin traducir ni fallback en inglés.
...
GEO PRO encaja bien en estos escenarios reales:
...
- **Sistema interno de gestión de contenido GEO**
  Para usar GEO PRO como backend interno de modelos, materiales, prompts, conocimiento, revisión y publicación. El objetivo es aumentar la eficiencia del equipo.
...
GEO PRO no está pensado para fabricar información falsa ni para saturar la web. Su propósito es mejorar la eficiencia del marketing con IA y de la operación GEO mediante contenido confiable.
...
Si la base de conocimiento es débil, la automatización solo amplificará el ruido. En GEO PRO, **la calidad de la base de conocimiento debe ir primero**.
...
GEO PRO está licenciado bajo la [Apache License 2.0](../../LICENSE). Permite uso personal y comercial, modificación, redistribución y despliegue privado, siempre que se respeten los avisos de licencia, copyright, cambios, términos de patente y exenciones de garantía.
