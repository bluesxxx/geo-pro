...
> GEO PRO is an open-source GEO (Generative Engine Optimization) content engineering and multi-site distribution system. It connects knowledge bases, material libraries, prompts, AI generation tasks, review and publishing, analytics, GEO PRO Agent target-site packages, WordPress REST channels, Generic HTTP API channels, and remote static-page distribution into one maintainable workflow for turning trustworthy source material into trackable, publishable, multi-channel GEO content assets.

[![PHP](https://img.shields.io/badge/PHP-8.3%2B-blue)](https://www.php.net/)
[![PostgreSQL](https://img.shields.io/badge/Database-PostgreSQL-336791)](https://www.postgresql.org/)
[![Docker](https://img.shields.io/badge/Docker-Compose-blue)](https://docs.docker.com/compose/)
[![License](https://img.shields.io/badge/License-Apache--2.0-blue.svg)](../../LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/bluesxxx/geo-pro?style=social)](https://github.com/bluesxxx/geo-pro/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/bluesxxx/geo-pro?style=social)](https://github.com/bluesxxx/geo-pro/network/members)
[![GitHub issues](https://img.shields.io/github/issues/bluesxxx/geo-pro)](https://github.com/bluesxxx/geo-pro/issues)

GEO PRO is released under the [Apache License 2.0](../../LICENSE). You may use, copy, modify, and distribute it, including for commercial purposes, provided that you retain copyright and license notices and comply with the patent, trademark, and warranty-disclaimer terms of Apache-2.0.
...
| 📡 Multi-site distribution | GEO PRO Agent, WordPress REST, and Generic HTTP API channels, secrets, target-site packages, static mode, rewrite rules, remote article editing/deletion, queues, and logs |
...
| 🎨 Front-end and themes | Default themes, theme packages, preview routes, admin switching, and GEO PRO Agent remote title/copyright/theme/category sync |
| 🌍 Admin i18n | Chinese, English, Japanese, Spanish, Russian, and Portuguese (Brazil), including GEO PRO 2.0 modules |
...
<table>
  <tr>
    <td width="34%" rowspan="3"><img src="../../docs/images/screenshots/analytics-en.png" alt="GEO PRO analytics preview" /><br /><sub>Analytics</sub></td>
    <td width="33%" rowspan="2"><img src="../../docs/images/screenshots/site-settings-en.png" alt="GEO PRO site settings preview" /><br /><sub>Site Settings</sub></td>
    <td width="33%"><img src="../../docs/images/screenshots/dashboard-en.png" alt="GEO PRO admin dashboard preview" /><br /><sub>Admin Dashboard</sub></td>
  </tr>
  <tr>
    <td width="33%"><img src="../../docs/images/screenshots/tasks-en.png" alt="GEO PRO task management preview" /><br /><sub>Task Management</sub></td>
  </tr>
  <tr>
    <td width="33%"><img src="../../docs/images/screenshots/ai-config-en.png" alt="GEO PRO AI model configuration preview" /><br /><sub>AI Model Configuration</sub></td>
    <td width="33%"><img src="../../docs/images/screenshots/materials-en.png" alt="GEO PRO materials preview" /><br /><sub>Materials</sub></td>
  </tr>
</table>
...
GEO PRO 2.0 highlights include:
...
- **Distribution Management is usable end to end**: GEO PRO Agent, WordPress REST, and Generic HTTP API channels, secrets, connection tests, target-site package downloads, static/rewrite modes, remote settings sync, queues, logs, remote editing, and remote deletion.
- **Publication scope is explicit**: tasks can publish locally and to channels, publish only to selected channels, or publish only to the local GEO PRO site. Local-only mode disables channel selection and never enters the remote distribution queue.
...
- **Localization coverage is complete for current admin keys**: GEO PRO 2.0 modules no longer fall back to raw translation keys or English copy.
...
7. Selected channels enqueue distribution and sync content to GEO PRO Agent or WordPress target sites
...
GEO PRO fits these practical scenarios:
...
GEO PRO is not for fabricating noise, mass pollution, or false claims—it helps teams produce and distribute **trustworthy** content and improve GEO operating efficiency.
...
Weak knowledge bases plus strong automation only scale noise. In GEO PRO, **knowledge-base quality comes first**.
...
```bash
curl -fsSL https://raw.githubusercontent.com/bluesxxx/geo-pro/main/deploy-scripts/geoflow-docker-deploy.sh -o geoflow-docker-deploy.sh
...
GEO PRO is licensed under the [Apache License 2.0](../../LICENSE). It allows personal and commercial use, modification, redistribution, and private deployment, as long as the license, copyright notices, modification notices, patent terms, and warranty disclaimers are respected.

---

## ⭐ Star history

[![Star History Chart](https://api.star-history.com/svg?repos=bluesxxx/geo-pro&type=Date)](https://star-history.com/#bluesxxx/geo-pro&Date)
