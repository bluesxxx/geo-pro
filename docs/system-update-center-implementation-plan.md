...
```json
{
  ...
  "tag": "v2.0.3",
  "archive_url": "https://github.com/bluesxxx/geo-pro/archive/refs/tags/v2.0.3.zip",
  ...
  "payload": {
    ...
    "release_url": "https://github.com/bluesxxx/geo-pro/releases/tag/v2.0.3",
    "changelog_url_zh": "https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG.md",
    "changelog_url_en": "https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG_en.md"
  }
}
```
...
GEOFLOW_UPDATE_ALLOWED_REPOSITORY=https://github.com/bluesxxx/geo-pro
