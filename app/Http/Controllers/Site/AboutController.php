...
class AboutController extends Controller
{
    public function index(): View
    {
        ...
        $pageDescription = 'GEO PRO 是面向生成式引擎优化的开源智能内容工程与多站点分发系统，连接知识、生成、审核、发布、分发和数据分析。';
        ...
        return SiteThemeViewResolver::first('about', [
            ...
            'pageTitle' => '关于 GEO PRO',
            'pageDescription' => $pageDescription,
            'pageKeywords' => 'GEO PRO,GEO,生成式引擎优化,开源内容系统,知识库,多站点分发',
            'pageOgType' => 'website',
            'canonicalUrl' => route('site.about'),
            'repositoryUrl' => 'https://github.com/bluesxxx/geo-pro',
        ]);
    }
}
