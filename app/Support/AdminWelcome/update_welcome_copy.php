...
return static function (array $welcomeState): array {
    ...
    return [
        'zh-CN' => [
            ...
            'letter' => [
                'title' => 'GEO PRO 有新版本可更新',
                'subtitle' => '当前版本 v'.$currentVersion.'，最新版本 v'.$latestVersion.'。',
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleZh !== '' ? $titleZh : '后台已经检测到 GEO PRO 上游仓库有一个新版本可用。',
                    ],
                    [
                        'type' => 'paragraph',
        ...
        'en' => [
            ...
            'letter' => [
                'title' => 'A new GEO PRO version is available',
                'subtitle' => 'Current version v'.$currentVersion.', latest version v'.$latestVersion.'.',
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleEn !== '' ? $titleEn : 'The admin has detected that a newer GEO PRO release is available in the upstream repository.',
                    ],
                    [
                        'type' => 'paragraph',
