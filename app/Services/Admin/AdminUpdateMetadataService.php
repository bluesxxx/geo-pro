...
/**
 * Checks upstream GEO PRO release metadata for admin update notifications.
 */
class AdminUpdateMetadataService
{
    ...
    public function buildNotificationPayload(): array
    {
        ...
        return [
            'state' => $state,
            'links' => [
                'github' => 'https://github.com/bluesxxx/geo-pro',
                'changelog' => [
                    'zh-CN' => (string) ($payload['changelog_url_zh'] ?? 'https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG.md'),
                    'en' => (string) ($payload['changelog_url_en'] ?? 'https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG_en.md'),
                ],
                'release' => (string) ($payload['release_url'] ?? 'https://github.com/bluesxxx/geo-pro'),
            ],
        ];
    }
