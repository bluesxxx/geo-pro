...
/**
 * 后台「欢迎使用 GEO PRO」弹窗：负责版本态判断、自动打开一次、以及关闭落库所需的数据。
 */
    ...
    public function buildModalPayload(Admin $admin): array
    {
        ...
        return [
            ...
            'state' => [
                ...
                'links' => [
                    'x' => 'https://jetsocio.com',
                    'github' => 'https://github.com/bluesxxx/geo-pro',
                    'changelog' => [
                        'zh-CN' => 'https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG.md',
                        'en' => 'https://github.com/bluesxxx/geo-pro/blob/main/docs/CHANGELOG_en.md',
                    ],
                ],
            ],
        ];
