...
/**
 * GEO PRO 业务相关配置（基于 GEOFlow fork；站点信息、后台路径、上传、缓存、会话与安全）。
 *
...
$defaultUpdateMetadataUrl = ''; // 自托管 fork：更新检查默认关闭；如自建元数据源，在此或环境变量配置。
...
// 上游默认注入百度统计，已移除；如需自建统计请在站点设置中配置。
$defaultAnalyticsCode = '';

return [

    // 站点展示名称（页眉、标题等）
    'site_name' => env('SITE_NAME', 'GEO PRO'),
    // 站点完整/副标题文案
    'site_full_name' => env('SITE_FULL_NAME', 'GEO PRO'),
